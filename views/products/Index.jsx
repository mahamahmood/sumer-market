                ...
                <div>
                    <header>
                        ...
                        <div class="sumer-p-btn-create">
                            ...
                            <a class="btn btn-outline-dark" role="button" href="/products/new">Create a New Product Page</a>
                        </div>
                    </header>
                    <div class="container">
                                        ...
                                        <div class="col mb-4">
                                            ...
                                            <div class="card card mb-1 sumer-card">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <a class="btn btn-outline-dark btn-product" role="button" href={`/products/${product._id}`}>View</a>
                                                    <a class="btn btn-outline-dark btn-product" role="button" href={`/products/${product._id}/edit`}>Edit</a>
                                                    {/* override post method to delete the product of this uniq id */}
                                                    <form action={`/products/${product._id}?_method=DELETE`} method='POST'>
                                                        <input class="btn btn-outline-dark btn-product" type='submit' value='Delete' />
                                                    </form>
                                                </div>
                                            </div>
                                        </div>
