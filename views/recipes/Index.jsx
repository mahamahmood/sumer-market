                ...
                <div>
                    <header>
                        ...
                        <div class="sumer-p-btn-create">
                            ...
                            <a class="btn btn-dark" role="button" href="/recipes/new">Create a New Recipe Page</a>
                        </div>
                    </header>
                    <div class="container">
                                        ...
                                        <div class="col mb-4">
                                            <div class="col card mb-1 sumer-card">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    {/* buttons */}
                                                    <div class="row">
                                                        <a class="col btn btn-outline-dark btn-recipe" role="button" href={`/recipes/${recipe._id}`}>View</a>
                                                        <a class="col btn btn-outline-dark btn-recipe" role="button" href={`/recipes/${recipe._id}/edit`}>Edit</a>
                                                        <form class="col" action={`/recipes/${recipe._id}?_method=DELETE`} method='POST'>
                                                            <input class="btn-delete  btn btn-outline-dark btn-recipe" type='submit' value='Delete' />
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
